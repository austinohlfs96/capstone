...
class EquipmentSchema(ma.SQLAlchemySchema):
  ...
  length = fields.Float(required=True, validate=validate.Range(min=50.0, max=300.0))
  width = fields.Float(required=True, validate=validate.Range(min=20.0, max=300.0))
